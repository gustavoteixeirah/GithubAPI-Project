...
public class SwaggerConfig {
    ...
    private ApiInfo apiInfo() {
        ApiInfo apiInfo = new ApiInfoBuilder()
                .title ("GitHub API")
                .description ("This is my implementation of the following Technical Challenge proposed by a company for a BackEnd Developers opportunity.")
                .version("1.0.0")
                .contact(new Contact("Gustavo Teixeira",null, "iwhrim@gmail.com"))
                .build();
